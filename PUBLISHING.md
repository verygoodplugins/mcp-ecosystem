...
- [ ] AGENTS.md exists for host-neutral agent guidance
...
- [ ] npm `files` allowlist is limited to `dist/` and release documentation
- [ ] npm `bin` targets an executable under `dist/`
